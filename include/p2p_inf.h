...
VOID RTMP_P2P_Init(IN PRTMP_ADAPTER ad_p, IN PNET_DEV main_dev_p);
...
INT P2P_VirtualIF_Ioctl(IN PNET_DEV dev_p,
			IN OUT struct ifreq *rq_p, IN INT cmd);

VOID RTMP_P2P_Remove(IN PRTMP_ADAPTER pAd);
