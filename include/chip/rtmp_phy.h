...
#ifdef MT7601
NDIS_STATUS MT7601_BBP_write(IN struct _RTMP_ADAPTER *pAd,
			     IN UCHAR regID, IN UCHAR value);

NDIS_STATUS MT7601_BBP_read(IN struct _RTMP_ADAPTER *pAd,
...
INT rtmp_bbp_set_filter_coefficient_ctrl(struct _RTMP_ADAPTER *pAd,
					 UCHAR Channel);
