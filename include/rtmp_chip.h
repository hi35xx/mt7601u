...
struct _RTMP_CHIP_OP_ {
	...
	/* EDCCA */
	 VOID(*ChipSetEDCCA) (IN struct _RTMP_ADAPTER * pAd, IN BOOLEAN bOn);
	...
	CHIP_SPEC_FUNC ChipSpecFunc[CHIP_SPEC_ID_NUM];
	 ...
	 INT(*Calibration) (struct _RTMP_ADAPTER * pAd, UINT32 CalibrationID,
			    UINT32 Parameter);
	 ...
	 INT(*RandomWrite) (struct _RTMP_ADAPTER * pAd,
			    /*BANK_RF_REG_PAIR *RegPair, */ UINT32 Num, ...);
