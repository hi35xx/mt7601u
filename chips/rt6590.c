...
UCHAR RT6590_EeBuffer[EEPROM_SIZE] = {
	0x83, 0x38, 0x01, 0x00, 0x00, 0x0c, 0x43, 0x28, 0x83, 0x00, 0x83, 0x28,
	    0x14, 0x18, 0xff, 0xff,
	0xff, 0xff, 0x83, 0x28, 0x14, 0x18, 0x00, 0x00, 0x01, 0x00, 0x6a, 0xff,
	    0x00, 0x02, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x0c, 0x43, 0x28,
	    0x83, 0x01, 0x00, 0x0c,
	0x43, 0x28, 0x83, 0x02, 0x33, 0x0a, 0xec, 0x00, 0x33, 0xff, 0xff, 0xff,
	    0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0x20, 0x01, 0x55, 0x77, 0xa8, 0xaa, 0x8c, 0x88, 0xff, 0xff,
	    0x0a, 0x08, 0x08, 0x06,
	...
	0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06,
	    0x06, 0x06, 0x06, 0x06,
	0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0xff, 0xff, 0xff,
	    0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x06, 0x06,
	    0x06, 0x06, 0x06, 0x06,
	0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06,
	    0x06, 0x06, 0x06, 0x06,
	0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06,
	...
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	    0xff, 0xff, 0xff, 0xff,
	0x66, 0x66, 0xcc, 0xaa, 0x88, 0x66, 0xcc, 0xaa, 0x88, 0x66, 0xcc, 0xaa,
	    0x88, 0x66, 0xcc, 0xaa,
	0x88, 0x66, 0xcc, 0xaa, 0x88, 0x66, 0xcc, 0xaa, 0x88, 0x66, 0xaa, 0xaa,
	    0x88, 0x66, 0xaa, 0xaa,
	0x88, 0x66, 0xaa, 0xaa, 0x88, 0x66, 0xcc, 0xaa, 0x88, 0x66, 0xcc, 0xaa,
	    0x88, 0x66, 0xcc, 0xaa,
	0x88, 0x66, 0xcc, 0xaa, 0x88, 0x66, 0xaa, 0xaa, 0x88, 0x66, 0xaa, 0xaa,
	    0x88, 0x66, 0xaa, 0xaa,
	0x88, 0x66, 0xaa, 0xaa, 0x88, 0x66, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	    0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	    0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static UCHAR RT6590_NUM_MAC_REG_PARMS =
    (sizeof(RT6590_MACRegTable) / sizeof(RTMP_REG_PAIR));
...
static UCHAR RT6590_BBP_InitRegTb_GBand_Tab_Size =
    (sizeof(RT6590_BBP_InitRegTb_GBand) / sizeof(RTMP_REG_PAIR));
...
static UCHAR RT6590_BBP_InitRegTb_ABand_Tab_Size =
    (sizeof(RT6590_BBP_InitRegTb_ABand) / sizeof(RTMP_REG_PAIR));
...
static UCHAR RT6590_DCOC_Tab_Size =
    (sizeof(RT6590_DCOC_Tab) / sizeof(RT6590_DOCO_Table));
...
static UINT32 RT6590_RF_Central_RegTb_Size =
    (sizeof(RT6590_RF_Central_RegTb) / sizeof(BANK_RF_REG_PAIR));
...
static UINT32 RT6590_RF_2G_Channel_0_RegTb_Size =
    (sizeof(RT6590_RF_2G_Channel_0_RegTb) / sizeof(BANK_RF_REG_PAIR));
...
static UINT32 RT6590_RF_5G_Channel_0_RegTb_Size =
    (sizeof(RT6590_RF_5G_Channel_0_RegTb) / sizeof(BANK_RF_REG_PAIR));
...
static UINT32 RT6590_RF_VGA_Channel_0_RegTb_Size =
    (sizeof(RT6590_RF_VGA_Channel_0_RegTb) / sizeof(BANK_RF_REG_PAIR));
...
static const RT6590_FREQ_ITEM RT6590_Frequency_Plan[] = {
	...
	/* Channel, Band,                                               PLL_N,  PLL_K,  Rdiv,   Non-Sigma,      Den,    LFC_R33,        LFC_R34,        Pll_idiv        Pll_LDO */
	{36, (RF_A_BAND | RF_A_BAND_LB), 0x2B, 0x02, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{38, (RF_A_BAND | RF_A_BAND_LB), 0x2B, 0x03, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{40, (RF_A_BAND | RF_A_BAND_LB), 0x2B, 0x04, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{42, (RF_A_BAND | RF_A_BAND_LB), 0x2B, 0x05, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{44, (RF_A_BAND | RF_A_BAND_LB), 0x2B, 0x06, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{46, (RF_A_BAND | RF_A_BAND_LB), 0x2B, 0x07, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{48, (RF_A_BAND | RF_A_BAND_LB), 0x2B, 0x08, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{50, (RF_A_BAND | RF_A_BAND_LB), 0x2B, 0x09, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{52, (RF_A_BAND | RF_A_BAND_LB), 0x2B, 0x0A, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{54, (RF_A_BAND | RF_A_BAND_LB), 0x2B, 0x0B, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{56, (RF_A_BAND | RF_A_BAND_LB), 0x2C, 0x00, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{58, (RF_A_BAND | RF_A_BAND_LB), 0x2C, 0x01, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{60, (RF_A_BAND | RF_A_BAND_LB), 0x2C, 0x02, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{62, (RF_A_BAND | RF_A_BAND_LB), 0x2C, 0x03, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{64, (RF_A_BAND | RF_A_BAND_LB), 0x2C, 0x04, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{100, (RF_A_BAND | RF_A_BAND_MB), 0x2D, 0x0A, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{102, (RF_A_BAND | RF_A_BAND_MB), 0x2D, 0x0B, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{104, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x00, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{106, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x01, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{108, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x02, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{110, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x03, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{112, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x04, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{114, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x05, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{116, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x06, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{118, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x07, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{120, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x08, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{122, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x09, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{124, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x0A, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{126, (RF_A_BAND | RF_A_BAND_MB), 0x2E, 0x0B, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{128, (RF_A_BAND | RF_A_BAND_MB), 0x2F, 0x00, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{130, (RF_A_BAND | RF_A_BAND_MB), 0x2F, 0x01, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{132, (RF_A_BAND | RF_A_BAND_MB), 0x2F, 0x02, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{134, (RF_A_BAND | RF_A_BAND_MB), 0x2F, 0x03, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{136, (RF_A_BAND | RF_A_BAND_MB), 0x2F, 0x04, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{138, (RF_A_BAND | RF_A_BAND_MB), 0x2F, 0x05, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{140, (RF_A_BAND | RF_A_BAND_MB), 0x2F, 0x06, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{142, (RF_A_BAND | RF_A_BAND_HB), 0x2F, 0x07, 0x03, 0x40, 0x04, 0x03,
	 0xDD, 0x30, 0x20},
	{144, (RF_A_BAND | RF_A_BAND_HB), 0x2F, 0x08, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{146, (RF_A_BAND | RF_A_BAND_HB), 0x2F, 0x09, 0x03, 0x40, 0x04, 0x12,
	 0xDD, 0x30, 0x20},
	{149, (RF_A_BAND | RF_A_BAND_HB), 0x2F, 0x15, 0x03, 0x40, 0x10, 0x03,
	 0xDD, 0x60, 0x20},
	{151, (RF_A_BAND | RF_A_BAND_HB), 0x2F, 0x17, 0x03, 0x40, 0x10, 0x03,
	 0xDD, 0x60, 0x20},
	{153, (RF_A_BAND | RF_A_BAND_HB), 0x30, 0x01, 0x03, 0x40, 0x10, 0x03,
	 0xDD, 0x60, 0x20},
	{155, (RF_A_BAND | RF_A_BAND_HB), 0x30, 0x03, 0x03, 0x40, 0x10, 0x03,
	 0xDD, 0x60, 0x20},
	{157, (RF_A_BAND | RF_A_BAND_HB), 0x30, 0x05, 0x03, 0x40, 0x10, 0x03,
	 0xDD, 0x60, 0x20},
	{159, (RF_A_BAND | RF_A_BAND_HB), 0x30, 0x07, 0x03, 0x40, 0x10, 0x03,
	 0xDD, 0x60, 0x20},
	{161, (RF_A_BAND | RF_A_BAND_HB), 0x30, 0x09, 0x03, 0x40, 0x10, 0x12,
	 0xDD, 0x60, 0x20},
	{163, (RF_A_BAND | RF_A_BAND_HB), 0x30, 0x0B, 0x03, 0x40, 0x10, 0x03,
	 0xDD, 0x60, 0x20},
	{165, (RF_A_BAND | RF_A_BAND_HB), 0x30, 0x0D, 0x03, 0x40, 0x10, 0x03,
	 0xDD, 0x60, 0x20},
	{167, (RF_A_BAND | RF_A_BAND_HB), 0x30, 0x0F, 0x03, 0x40, 0x10, 0x12,
	 0xDD, 0x60, 0x20},
	{169, (RF_A_BAND | RF_A_BAND_HB), 0x30, 0x11, 0x03, 0x40, 0x10, 0x03,
	 0xDD, 0x60, 0x20},
	{171, (RF_A_BAND | RF_A_BAND_HB), 0x30, 0x13, 0x03, 0x40, 0x10, 0x03,
	 0xDD, 0x60, 0x20},
	{173, (RF_A_BAND | RF_A_BAND_HB), 0x30, 0x15, 0x03, 0x40, 0x10, 0x03,
	 0xDD, 0x60, 0x20},
};

UCHAR NUM_OF_6590_CHNL =
    (sizeof(RT6590_Frequency_Plan) / sizeof(RT6590_FREQ_ITEM));
...
UCHAR RT6590_RF_BW_Switch_Size =
    (sizeof(RT6590_RF_BW_Switch) / sizeof(RT6590_RF_SWITCH_ITEM));
...
UCHAR RT6590_RF_Band_Switch_Size =
    (sizeof(RT6590_RF_Band_Switch) / sizeof(RT6590_RF_SWITCH_ITEM));

//2 REMOVE: For test chip only
//
// Initialize TC6008 configurations
//
VOID InitTC6008Config(IN PRTMP_ADAPTER pAd)
{
	ULONG MacReg = 0;
	ULONG BbValue = 0;
...
*/
VOID SelectBand6590(IN PRTMP_ADAPTER pAd, IN UCHAR Channel)
{
	UCHAR RfValue = 0;
	...
	if (Channel <= 14) {
		...
		/*
		   Select 2.4GHz 
		 */
		RFRandomWritePair(pAd, RT6590_RF_2G_Channel_0_RegTb,
				  RT6590_RF_2G_Channel_0_RegTb_Size);
		...
		RandomWritePair(pAd, RT6590_BBP_InitRegTb_GBand,
				RT6590_BBP_InitRegTb_GBand_Tab_Size);
		...
		/*
		   Select 5GHz 
		 */
		RFRandomWritePair(pAd, RT6590_RF_5G_Channel_0_RegTb,
				  RT6590_RF_5G_Channel_0_RegTb_Size);
		...
		RandomWritePair(pAd, RT6590_BBP_InitRegTb_ABand,
				RT6590_BBP_InitRegTb_ABand_Tab_Size);
	...
	for (IdReg = 0; IdReg < RT6590_RF_BW_Switch_Size; IdReg++) {
		if (pAd->CommonCfg.BBPCurrentBW ==
		    RT6590_RF_BW_Switch[IdReg].BW) {
			rlt_rf_write(pAd, RT6590_RF_BW_Switch[IdReg].Bank,
...
*/
VOID SetRfChFreqParameters6590(IN PRTMP_ADAPTER pAd, IN UCHAR Channel)
{
	ULONG i = 0;
	...
	for (i = 0; i < NUM_OF_6590_CHNL; i++) {
		if (Channel == RT6590_Frequency_Plan[i].Channel) {
			...
			RFValue &= ~(0x1);
			RFValue |=
			    ((RT6590_Frequency_Plan[i].PLL_N >> 8) & 0x0001);
			...
			/*
			   Loop Filter Config: R33, R34
			 */
			rlt_rf_write(pAd, RF_BANK0, RF_R33,
				     RT6590_Frequency_Plan[i].LFC_R33);
			rlt_rf_write(pAd, RF_BANK0, RF_R34,
...
static VOID NICInitRT6590RFRegisters(RTMP_ADAPTER * pAd)
{
	...
	RFRandomWritePair(pAd, RT6590_RF_Central_RegTb,
			  RT6590_RF_Central_RegTb_Size);
	...
	RFRandomWritePair(pAd, RT6590_RF_VGA_Channel_0_RegTb,
			  RT6590_RF_VGA_Channel_0_RegTb_Size);
...
========================================================================
*/
static VOID NICInitRT6590BbpRegisters(IN PRTMP_ADAPTER pAd)
{
...
static VOID RT6590_AsicAntennaDefaultReset(IN struct _RTMP_ADAPTER *pAd,
...
static VOID RT6590_ChipSwitchChannel(struct _RTMP_ADAPTER *pAd,
				     UCHAR Channel, BOOLEAN bScan)
{
	...
	for (IdReg = 0; IdReg < RT6590_DCOC_Tab_Size; IdReg++) {
		RTMP_BBP_IO_WRITE32(pAd,
				    RT6590_DCOC_Tab[IdReg].RegDate.Register,
...
VOID RT6590_NICInitAsicFromEEPROM(IN PRTMP_ADAPTER pAd)
{
...
static UCHAR rt6590_txpwr_chlist[] = {
	...
	100, 102, 104, 108, 110, 112, 116, 118, 120, 124, 126, 128, 132, 134,
	    136, 140,
...
INT RT6590_ReadChannelPwr(RTMP_ADAPTER * pAd)
{
...

	{
		...
		for (i = 0; i < 6; i++) {
			idx = i * 2;
			RT28xx_EEPROM_READ16(pAd, EEPROM_A_TX_PWR_OFFSET + idx,
					     Power.word);

			if ((Power.field.Byte0 < 0x20)
			    && (Power.field.Byte0 >= 0))
				pAd->TxPower[idx + choffset + 0].Power =
				    Power.field.Byte0;

			if ((Power.field.Byte1 < 0x20)
			    && (Power.field.Byte1 >= 0))
				pAd->TxPower[idx + choffset + 1].Power =
				    Power.field.Byte1;
		}
		...
		for (i = 0; i < choffset; i++) {
			DBGPRINT(RT_DEBUG_TRACE,
				 ("E2PROM: TxPower[%03d], Channel=%d, Power[Tx:%d]\n",
				  i, pAd->TxPower[i].Channel,
				  pAd->TxPower[i].Power));
		}
	}
...
VOID RT6590_AsicExtraPowerOverMAC(IN PRTMP_ADAPTER pAd)
{
	ULONG ExtraPwrOverMAC = 0;
	ULONG ExtraPwrOverTxPwrCfg7 = 0, ExtraPwrOverTxPwrCfg8 =
	    0, ExtraPwrOverTxPwrCfg9 = 0;
...
//
VOID RT6590ReadTxPwrPerRate(IN PRTMP_ADAPTER pAd)
{
	UINT32 data, DataBw40ABand, DataBw80ABand, DataBw40GBand;
	USHORT i, value, value2;
	INT TxPwrBw40ABand, TxPwrBw80ABand, TxPwrBw40GBand;
	UCHAR t1, t2, t3, t4;
	BOOLEAN bMinusBw40ABand = FALSE, bMinusBw80ABand =
	    FALSE, bMinusBw40GBand = FALSE;
	...
	DBGPRINT(RT_DEBUG_TRACE,
		 ("%s: bMinusBw40ABand = %d, bMinusBw80ABand = %d, bMinusBw40GBand = %d\n",
		  __FUNCTION__, bMinusBw40ABand, bMinusBw80ABand,
		  bMinusBw40GBand));

	DBGPRINT(RT_DEBUG_TRACE,
		 ("%s: TxPwrBw40ABand = %d, TxPwrBw80ABand = %d, TxPwrBw40GBand = %d\n",
		  __FUNCTION__, TxPwrBw40ABand, TxPwrBw80ABand,
		  TxPwrBw40GBand));
	...
	for (i = 0; i < 5; i++) {
		...
		DBGPRINT_RAW(RT_DEBUG_TRACE,
			     ("%s: data = 0x%X,  DataBw40ABand = 0x%X,  DataBw80ABand = 0x%X, DataBw40GBand = 0x%x\n",
			      __FUNCTION__, data, DataBw40ABand, DataBw80ABand,
			      DataBw40GBand));
	}
